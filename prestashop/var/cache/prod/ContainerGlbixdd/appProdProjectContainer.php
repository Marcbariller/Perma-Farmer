...
class appProdProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : ($this->services['doctrine.dbal.connection_factory'] = new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))) && false ?: '_'}->createConnection(['driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => '', 'dbname' => 'perma_farmer', 'user' => 'root', 'password' => '', 'charset' => 'UTF8', 'driverOptions' => [1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))'], 'serverVersion' => 5.1, 'defaultTableOptions' => []], new \Doctrine\DBAL\Configuration(), $a, ['enum' => 'string']);
    }
    ...
    {
        return $this->services['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(${($_ = isset($this->services['uri_signer']) ? $this->services['uri_signer'] : ($this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('98e6TgV5isdKHao1946Fpt0QAyXZbxG7GRwzReYQFeT6qzKyP2gsNRhk'))) && false ?: '_'}, '/_fragment');
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('98e6TgV5isdKHao1946Fpt0QAyXZbxG7GRwzReYQFeT6qzKyP2gsNRhk');
    }
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'secret' => '98e6TgV5isdKHao1946Fpt0QAyXZbxG7GRwzReYQFeT6qzKyP2gsNRhk',
            'ps_caching' => 'CacheMemcache',
            'ps_cache_enable' => false,
            'ps_creation_date' => '2019-09-18',
            'locale' => 'fr-FR',
            'cookie_key' => 'VV2U6HBnr8zqLVIkyAV6zZ7z2gbRTDp1mp9ErB6NGxf1IHB7zdI7GT74',
            'cookie_iv' => 'c1doa6y4',
            'new_cookie_key' => 'def00000913173bf495e86cd0da6ee0656d3c23eba58beba8aa5189374398376ff084a457edcc5d86ce71f4383c08ed6df14339dcb1414e2a901b6cf0e15e5dc5278bb01',
            'cache.driver' => 'array',
            ...
            'kernel.secret' => '98e6TgV5isdKHao1946Fpt0QAyXZbxG7GRwzReYQFeT6qzKyP2gsNRhk',
